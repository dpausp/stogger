...
.. autoapisummary::
   ...
   nicestlog.config.ProjectStructure
   nicestlog.config.NicestLogConfig
   nicestlog.config.SimpleFormatSettings
...
.. autoapisummary::
   ...
   nicestlog.config.detect_project_structure
