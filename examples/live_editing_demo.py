...
def main():
    ...
    print(f"  stoggertools tools ast interactive {demo_file} --verbose")
    print()
    print("Or disable live editing if you prefer classic mode:")
    print(f"  stoggertools tools ast interactive {demo_file} --no-live-editing")
    print()
    print("For external editor support (vim, nano, etc.):")
    print(f"  stoggertools tools ast interactive {demo_file} --external-editor")
    print()
    ...
    print()
    print("   💾 Edit data saved to: stogger_edit_sessions_1234567890.json")
    print()
