...
def simulate_api_request():
    ...
    with log_action("api_request", method="POST", endpoint="/api/users", user_agent="demo/1.0"):
        ...
        with log_action("authenticate", token_type="bearer"):
            ...
            log_message(message_type="token_validated", user_id=42, permissions=["read", "write"])
        ...
        with log_action("database_operations"):
            ...
            with log_action("user_lookup", user_id=42):
                time.sleep(0.05)
                log_message(message_type="query_executed", 
            ...
            with log_action("user_update", fields=["email", "last_login"]):
                time.sleep(0.08)
                log_message(message_type="update_executed", 
                           rows_affected=1, 
        ...
        log_message(message_type="response_prepared", 
                   status_code=200, 
                   response_size=2048,
