...
def demo_pii_protection():
    ...
    log.warning("payment_processing",
                user_email="customer@example.com",
                credit_card="4532-1234-5678-9012",  # This should be redacted!
                amount=99.99,
                api_key="sk_live_abc123xyz789")  # This should be redacted!
    ...
    log.error("authentication_failed",
              ...
              session_id="sess_abc123")  # This should be redacted!
    ...
    log.debug("database_query",
              sql="SELECT * FROM users WHERE email = 'test@example.com'",  # Email in SQL should be redacted!
              execution_time=0.045)
    
    print("\n🎉 Demo complete!")
    print("💡 Notice how emails, passwords, phone numbers, etc. are automatically [REDACTED]")
...
def demo_custom_pii_config():
    ...
    log.info("employee_record",
             ...
             internal_notes="Confidential performance review")  # Sensitive field - should be redacted
