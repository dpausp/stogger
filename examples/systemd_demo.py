...
def demo_systemd_features():
    ...
    for i in range(3):
        ...
        if i == 1:
            log.warning("rate_limit_warning",
                       user_id=42,
    ...
    # Recovery
    log.info("database_connection_restored",
...
def show_systemd_commands():
    ...
    commands = [
        ...
        ("Show logs from last hour", "journalctl -u myapp.service --since '1 hour ago'"),
