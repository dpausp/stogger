...
def main():
    ...
    print("   Output: 2025-08-16T00:18:57.672408 I lock-try Looks like another management command is running")
    print()
    ...
    log.info("lock-try", _replace_msg="Looks like another management command is running")
