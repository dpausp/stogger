...
ERROR: Database connection failed'''
    ...
    def test_calculate_quality_score_perfect_logs(self):
        ...
        stats = {
            ...
            'events_found': {'user_login', 'api_request', 'db_query', 'auth_check', 'data_process'},
            'fields_found': {'user_id': 50, 'request_id': 50, 'session_id': 50, 'action': 100, 'status': 100, 'timestamp': 100, 'level': 100, 'message': 100, 'duration': 30, 'ip_address': 50},
    ...
    def test_find_good_practices(self):
        ...
        stats = {
            ...
            'timestamps_found': 90,
            'debug_prints': 0,
            'fields_found': {'field1': 10, 'field2': 10, 'field3': 10, 'field4': 10, 'field5': 10, 'field6': 10, 'field7': 10, 'field8': 10},
        }
    ...
    def test_review_logs_cli_directory(self, mock_is_dir, mock_is_file):
        ...
        with patch('src.nicestlog.log_reviewer.LogQualityReviewer') as mock_reviewer_class:
            ...
            with patch('pathlib.Path.glob') as mock_glob:
                mock_glob.side_effect = [mock_log_files, []]  # *.log files, then *.txt files
