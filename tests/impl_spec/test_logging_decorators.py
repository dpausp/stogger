...
def test_log_call_produces_called_event(log):
...
def test_log_result_produces_returned_event(log):
...
def test_log_operation_produces_operation_event(log):
...
def test_log_scope_success_produces_scope_end_event(log):
...
def test_log_scope_exception_produces_scope_failed_event(log):
...
def test_log_call_works_with_async(log):
...
def test_log_operation_works_with_async(log):
...
def test_log_scope_works_with_async_with(log):
...
def test_args_include_default_values(log):
...
def test_log_result_has_duration_ms(log):
...
def test_log_operation_has_duration_ms(log):
...
def test_log_scope_has_duration_ms(log):
...
def test_log_result_logs_exception_and_reraises(log):
...
def test_log_operation_logs_exception_with_args(log):
...
def test_log_call_does_not_catch_exceptions(log):
    ...
    assert len(log.events) == 1
    assert log.events[0]["event"] == "called"


def test_log_scope_exception_reraises(log):
...
def test_func_field_is_module_qualname(log):
...
def test_func_field_for_method(log):
