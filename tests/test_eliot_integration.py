...
class TestHumanReadableEliotDestination:
    ...
    def test_handle_action_start_with_task_ids(self):
        ...
        output = io.StringIO()
        dest = HumanReadableEliotDestination(file=output, show_task_ids=True, show_timestamps=False)
...
class TestLogActionContextManager:
    ...
    def test_log_action_eliot_unavailable(self, mock_eliot_unavailable):
        ...
        eliot_mod.log_action = eliot_mod.log_action.__wrapped__ if hasattr(eliot_mod.log_action, '__wrapped__') else original_log_action
    ...
    def test_demo_eliot_available(self, mock_eliot_available):
        ...
        with patch('src.nicestlog.eliot_integration.setup_eliot_logging') as mock_setup:
            with patch('builtins.print') as mock_print:
                ...
                mock_setup.assert_called_once_with(human_readable=True, show_timestamps=True)
