...
class JournalViewer:
    ...
    def __init__(self, show_hostname: bool = False, show_pid: bool = True, 
                 show_service: bool = True, max_width: int = 120):
        """
        ...
        if entry.fields:
            ...
            for key, value in entry.fields.items():
                if isinstance(value, (dict, list)):
                    ...
                    value_str = str(value)
                field_parts.append(f"{CYAN}{key}{RESET_ALL}={MAGENTA}{value_str}{RESET_ALL}")
    ...
    def query_journal(self, service: str = None, since: str = None, 
                     until: str = None, level: str = None, 
                     lines: int = None, follow: bool = False) -> Iterator[JournalEntry]:
        """
...
def main():
    ...
    parser.add_argument('-u', '--unit', '--service', dest='service',
    ...
    parser.add_argument('--level', choices=['critical', 'error', 'warning', 'info', 'debug'],
                       help='Minimum log level to show')
    parser.add_argument('--show-hostname', action='store_true',
                       help='Show hostname in output')
    parser.add_argument('--show-pid', action='store_true', default=True,
